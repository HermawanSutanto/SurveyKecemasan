                ...
                <div class="bg-white shadow-md rounded-lg p-6">
                    ...
                    <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="file" id="foto_profil" name="foto_profil" class="form-input w-full">
                        </div>
                        <!-- Submit Button -->
                        <div class="flex justify-center">
                            <button type="submit" class="bg-yellow-300 text-black px-4 py-2 rounded-md">Update Profil</button>
                        </div>
                    </form>
                </div>
            </div>
